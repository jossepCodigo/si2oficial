                        ...
                        @foreach($orders as $order)
                            <tr>
                                ...
                                <td>{{ $order->estado }}
                                    <a
                                        href="#" 
                                        class="btn btn-warning btn-update-order"
                                        data-href="{{ route('admin.order.update',$order->id) }}"
                                        data-id = "{{$order->id}}"
                                    >
                                ...
                                <td>Bs.{{ number_format($order->shipping,2) }}</td>
                                <td>Bs.{{ number_format($order->subtotal + $order->shipping,2) }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
